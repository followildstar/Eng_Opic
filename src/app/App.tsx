...
function HomeScreen({ questions, onDetail, onRandom, onTab }: {
  ...
  return (
    <div className="pb-24 px-5 pt-8">
      <div className="mb-7">
        <p className="text-[11px] font-medium tracking-widest text-[#7A7268] uppercase mb-1">Welcom seo</p>
        <h1 className="font-display text-[26px] font-semibold text-[#17150E] leading-tight">Eng Flow Trainer</h1>
